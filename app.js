      ...
      <main class="page-shell">
        ...
        <div class="hero__content reveal is-visible">
          ...
          <p class="hero__body">
            ...
            スマホのカメラでQRコードを読み込むだけ。<br />スマホ側の専用アプリも、アカウント作成も不要。<br />
        ...
        <section class="clipboard-shift" aria-labelledby="clipboard-shift-title">
          <div class="clipboard-shift__reveal reveal">
            ...
            <div class="clipboard-shift__prose">
              <p>
                多くのクリップボードマネージャーは、使うたびに検索窓やポップアップをMac画面内で「呼び出す」必要がありました。
              </p>
              <p>
                しかし、その画面切り替えで、小さな集中の途切れを生んでいます。<br />ペースト用ショートカットを忘れてしまうこともあるでしょう。
              </p>
              <p class="clipboard-shift__emphasis">SideClipは、その発想を変えました。</p>
              <p>
                コピー履歴をMac画面の中で「呼び出す」のではなく、
                スマホを「横に置いて常時表示」のクリップボード画面として使います。
              </p>
              <p>
                探す、思い出す、呼び出す負担を減らし、コピー＆ペーストをもっと直感的に。
              </p>
              <p>
                クリップボードを“操作するもの”から、“横に置いて使うもの”へ変わります。
              </p>
            </div>
          </div>
        </section>
