(function () {
  ...
  const landingEntries = [
    ...
    ["html", ".benefits .section-copy .reveal__rest p", "Start Mac screenshots from your phone.<br />SideClip saves them as cards, ready to reuse whenever you need them."],
    ["text", ".benefits-video-copy__eyebrow", "Screenshot Demo"],
    ["html", ".benefits-video-copy h3", "Screenshots,<br />saved as cards."],
    ["text", ".benefits-video-copy__text:nth-of-type(2)", "Capture a screenshot from the shortcut button. SideClip organizes consecutive shots as cards, ready to paste again."],
    ["text", ".benefits-video-copy__text:nth-of-type(3)", "Screenshots are stored in the SideClip folder instead of cluttering your desktop. Swipe frequently used shots into Favorites."],
    ...
    ["text", ".feature-card:nth-child(3) .feature-card__eyebrow", "Save"],
    ...
    ["text", ".ja-pricing__head > p:last-child", "No account is required for Free. Paid plans include a 30-day free trial, and you can change or cancel in the SideClip app."],
    ...
    ["text", "#download .final-cta__action > p:last-of-type", "macOS 26 or later · Apple Silicon Mac"],
