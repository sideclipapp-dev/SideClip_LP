(function () {
  ...
  const landingEntries = [
    ...
    ["text", ".section-drawer__panel a:nth-child(11)", "Plans"],
    ...
    ["text", ".feature-card:nth-child(3) h3", "Find old cards fast."],
    ["html", ".feature-card:nth-child(3) > p:not(.feature-card__eyebrow)", "Search by date range, keyword, and text inside images.<br />Even fuzzy terms can bring back the card you need.<br /><small>Text search inside images is available on Pro and above.</small>"],
    ["attr", ".feature-card:nth-child(3) .feature-card__panel", "aria-label", "Zoom image of the search screen"],
    ["attr", ".feature-card:nth-child(3) .feature-card__panel", "data-feature-image-alt", "Search screen for copy and screenshot history"],
    ["attr", ".feature-card:nth-child(3) .feature-card__image", "alt", "Search screen for copy and screenshot history"],
    ["text", ".feature-card:nth-child(4) h3", "Mac screenshots become cards."],
    ["html", ".feature-card:nth-child(4) > p:not(.feature-card__eyebrow)", "Start a Mac screenshot from your phone.<br />Mark it up, crop it, and save it directly in your history."],
    ["attr", ".feature-card:nth-child(4) .feature-card__panel", "aria-label", "Zoom image of the screenshot capture screen"],
    ["attr", ".feature-card:nth-child(4) .feature-card__panel", "data-feature-image-alt", "Screenshot capture screen"],
    ["attr", ".feature-card:nth-child(4) .feature-card__image", "alt", "Screenshot capture screen"],
    ["attr", ".feature-card:nth-child(4) .feature-card__video-trigger", "aria-label", "Play the pen and crop demo video"],
    ["attr", ".feature-card:nth-child(4) .feature-card__video-trigger", "data-video-title", "SideClip pen and crop demo video"],
    ["text", ".feature-card:nth-child(4) .feature-card__video-kicker", "Demo Video"],
    ["text", ".feature-card:nth-child(4) .feature-card__video-label", "Watch pen and crop demo"],
    ...
    ["html", ".feature-card:nth-child(5) > p:not(.feature-card__eyebrow)", "Swipe a card into Todo mode.<br />Prioritize copied items you do not want to lose."],
