(function () {
  ...
  const landingEntries = [
    ...
    ["html", ".hero__banner-overlay-sub", "Keep your phone nearby.<br />Copied items stay in view."],
    ["text", ".hero__banner-primary", "Download free for Mac"],
    ["text", ".hero__banner-note", "Supports Macs with Apple Silicon"],
    ["html", ".hero__banner-copy", "A place for copied items,<br />beside your Mac."],
    ...
    ["text", ".section-drawer__panel a:nth-child(3)", "How it works"],
    ["text", ".section-drawer__panel a:nth-child(4)", "Benefits"],
    ["text", ".section-drawer__panel a:nth-child(5)", "Why SideClip"],
    ["text", ".section-drawer__panel a:nth-child(6)", "Core features"],
    ["text", ".section-drawer__panel a:nth-child(7)", "Use cases"],
    ["text", ".section-drawer__panel a:nth-child(8)", "Local sync"],
    ["text", ".section-drawer__panel a:nth-child(9)", "FAQ"],
    ["text", ".section-drawer__panel a:nth-child(10)", "Download"],
    ["text", ".section-drawer__panel a:nth-child(11)", "Plans & pricing"],
    ["text", ".section-drawer__panel a:nth-child(12)", "Policies & terms"],
    ...
    ["html", ".mini-flow [data-flow-index='1'] .step-card__label", "See it on<br />your phone"],
