(function () {
  ...
  const landingEntries = [
    ...
    ["text", ".hero-highlight-card:nth-child(1) .hero-highlight-card__text", "Your clipboard history is not sent to SideClip cloud storage."],
    ["text", ".hero-highlight-card:nth-child(2) .hero-highlight-card__title", "No account required"],
    ["text", ".hero-highlight-card:nth-child(2) .hero-highlight-card__text", "No email address, password, or login is required."],
    ["text", ".hero-highlight-card:nth-child(3) .hero-highlight-card__title", "Only QR-paired devices connect"],
    ["text", ".hero-highlight-card:nth-child(3) .hero-highlight-card__text", "Even on the same Wi-Fi, only paired devices can connect."],
    ["text", ".hero-highlight-card:nth-child(4) .hero-highlight-card__title", "Signed and notarized by Apple"],
    ["text", ".hero-highlight-card:nth-child(4) .hero-highlight-card__text", "The DMG is distributed with Apple Developer ID signing and Apple notarization."],
