(function () {
  ...
  const EN_ASSETS = {
    heroPhone: `/assets/optimized-en/hero-phone-1024.png?v=${HERO_PHONE_ASSET_VERSION}`,
    heroPhoneSrcset: `/assets/optimized-en/hero-phone-512.png?v=${HERO_PHONE_ASSET_VERSION} 341w, /assets/optimized-en/hero-phone-1024.png?v=${HERO_PHONE_ASSET_VERSION} 682w`,
  ...
  const landingEntries = [
    ...
    ["html", ".hero__infographic-title .tap-infographic__title-line--primary", "Connect once.<br />Then paste in three steps."],
    ...
    ["attr", ".hero__visual-layer--phone", "srcset", EN_ASSETS.heroPhoneSrcset],
    ...
    ["text", ".trust-summary__eyebrow", "Trust & Safety"],
    ["text", "#trust-summary-title", "Four reasons to try SideClip with confidence."],
    ["attr", ".hero-highlight-row", "aria-label", "Four reasons to try SideClip with confidence"],
    ["text", ".hero-highlight-card:nth-child(1) .hero-highlight-card__title", "History stays on your Mac"],
    ["text", ".hero-highlight-card:nth-child(1) .hero-highlight-card__text", "Stored on your Mac, never in SideClip cloud storage."],
    ["text", ".hero-highlight-card:nth-child(2) .hero-highlight-card__title", "No account required"],
    ["text", ".hero-highlight-card:nth-child(2) .hero-highlight-card__text", "No email address or login is required."],
    ["text", ".hero-highlight-card:nth-child(3) .hero-highlight-card__title", "Only QR-paired devices connect"],
    ["text", ".hero-highlight-card:nth-child(3) .hero-highlight-card__text", "Only paired devices connect, even on the same Wi-Fi."],
    ["text", ".hero-highlight-card:nth-child(4) .hero-highlight-card__title", "Signed and notarized by Apple"],
    ["text", ".hero-highlight-card:nth-child(4) .hero-highlight-card__text", "The DMG is signed and notarized by Apple."],
    ...
    ["attr", ".concept-video__chapters", "aria-label", "Product demo chapters"],
    ["text", ".concept-video__chapters-title", "Jump to a feature"],
    ["text", ".concept-video__chapter:nth-child(1) .concept-video__chapter-time", "0:00"],
    ["text", ".concept-video__chapter:nth-child(1) .concept-video__chapter-label", "Copy & paste"],
    ["attr", ".concept-video__chapter:nth-child(1)", "aria-label", "Play Copy & paste from 0:00"],
    ["attr", ".concept-video__chapter:nth-child(1)", "data-concept-video-seconds", "0"],
    ["attr", ".concept-video__chapter:nth-child(1)", "data-concept-video-label", "Copy & paste"],
    ["text", ".concept-video__chapter:nth-child(2) .concept-video__chapter-time", "0:24"],
    ["text", ".concept-video__chapter:nth-child(2) .concept-video__chapter-label", "Screenshots"],
    ["attr", ".concept-video__chapter:nth-child(2)", "aria-label", "Play Screenshots from 0:24"],
    ["attr", ".concept-video__chapter:nth-child(2)", "data-concept-video-seconds", "24"],
    ["attr", ".concept-video__chapter:nth-child(2)", "data-concept-video-label", "Screenshots"],
    ["text", ".concept-video__chapter:nth-child(3) .concept-video__chapter-time", "0:44"],
    ["text", ".concept-video__chapter:nth-child(3) .concept-video__chapter-label", "Favorites"],
    ["attr", ".concept-video__chapter:nth-child(3)", "aria-label", "Play Favorites from 0:44"],
    ["attr", ".concept-video__chapter:nth-child(3)", "data-concept-video-seconds", "44"],
    ["attr", ".concept-video__chapter:nth-child(3)", "data-concept-video-label", "Favorites"],
    ["text", ".concept-video__chapter:nth-child(4) .concept-video__chapter-time", "1:04"],
    ["text", ".concept-video__chapter:nth-child(4) .concept-video__chapter-label", "Todo"],
    ["attr", ".concept-video__chapter:nth-child(4)", "aria-label", "Play Todo from 1:04"],
    ["attr", ".concept-video__chapter:nth-child(4)", "data-concept-video-seconds", "64"],
    ["attr", ".concept-video__chapter:nth-child(4)", "data-concept-video-label", "Todo"],
    ["text", ".concept-video__chapter:nth-child(5) .concept-video__chapter-time", "1:34"],
    ["text", ".concept-video__chapter:nth-child(5) .concept-video__chapter-label", "Quick Paste & data"],
    ["attr", ".concept-video__chapter:nth-child(5)", "aria-label", "Play Quick Paste & data from 1:34"],
    ["attr", ".concept-video__chapter:nth-child(5)", "data-concept-video-seconds", "94"],
    ["attr", ".concept-video__chapter:nth-child(5)", "data-concept-video-label", "Quick Paste & data"],
    ["text", ".concept-video__cta a", "Download free for Mac"],
    ["attr", ".concept-video__cta a", "aria-label", "Download SideClip free for Mac"],
    ["text", ".concept-video__cta p", "No account required. Start with the Free plan."],
    ...
    ["text", ".benefits .screenshot-flow-label__text", "Capture with SCAN"],
    ...
    ["html", ".benefits-video-copy__continuation a", "Next, crop or mark up<span class=\"benefits-video-copy__continuation-tail\">&nbsp;your screenshot&nbsp;<span aria-hidden=\"true\">→</span></span>"],
    ...
    ["text", ".clipboard-shift__eyebrow", "Why SideClip"],
    ["html", "#clipboard-shift-title", "A place for clipboard history,<br />beside your Mac."],
    ["html", ".clipboard-shift__lead", "Traditional clipboard managers open history over your Mac screen.<br />SideClip moves that history to the phone beside it."],
    ["text", ".clipboard-shift__figure-legend-item--before .clipboard-shift__figure-legend-copy", "Open it on screen"],
    ["text", ".clipboard-shift__figure-legend-item--after .clipboard-shift__figure-legend-copy", "Keep it beside your Mac"],
    ["attr", ".clipboard-shift__panel", "data-feature-image-alt", "Before-and-after comparison of a traditional clipboard manager and SideClip"],
    ["attr", ".clipboard-shift__panel", "data-feature-image-src", EN_ASSETS.clipboardDifference],
    ["attr", ".clipboard-shift__panel", "aria-label", "Zoom the before-and-after comparison of a traditional clipboard manager and SideClip"],
    ...
    ["attr", ".clipboard-shift__panel img", "alt", "Before-and-after comparison of a traditional clipboard manager and SideClip"],
    ...
    ["text", ".feature-card:nth-child(3) .screenshot-flow-label__text", "Crop & mark up"],
    ...
    ["text", ".local-sync__point:nth-child(3) h3", "Only paired devices connect"],
    ["text", ".local-sync__point:nth-child(3) p", "Only phones and tablets paired with the QR code can connect to SideClip."],
    ["text", ".local-sync__detail-copy strong", "See how SideClip protects connections and data"],
    ["text", ".local-sync__detail-copy span", "Learn about encrypted communication, QR pairing, and safe sharing."],
    ["text", ".local-sync__detail-cta a", "View security details"],
    ...
    ["text", ".ja-pricing__card:nth-child(1) .ja-pricing__label", "For trying the essentials"],
    ["html", ".ja-pricing__card:nth-child(1) .ja-pricing__price", "$0"],
    ["text", ".ja-pricing__card:nth-child(1) .ja-pricing__summary", "Try clipboard and screenshot history for free and confirm SideClip works on your Mac."],
    ["text", ".ja-pricing__card:nth-child(1) .ja-pricing__card-cta", "Start free"],
    ["attr", ".ja-pricing__card:nth-child(1) .ja-pricing__card-cta", "aria-label", "Download the Free plan for Mac"],
    ["text", ".ja-pricing__card:nth-child(2) .ja-pricing__label", "For daily professional use"],
    ...
    ["text", ".ja-pricing__card:nth-child(2) .ja-pricing__summary", "Speed up daily work with Todo, image editing, Quick Paste, and more."],
    ["text", ".ja-pricing__card:nth-child(2) .ja-pricing__card-cta", "Try 30 days free in the app"],
    ["attr", ".ja-pricing__card:nth-child(2) .ja-pricing__card-cta", "aria-label", "Try the Pro plan free for 30 days in the SideClip app"],
    ["text", ".ja-pricing__card:nth-child(2) .ja-pricing__card-link", "Explore Pro features →"],
    ["text", ".ja-pricing__card:nth-child(3) .ja-pricing__label", "For keeping more history"],
    ...
    ["text", ".ja-pricing__card:nth-child(3) .ja-pricing__summary", "Keep more history with unlimited storage, CSV export, backup, and restore."],
    ["text", ".ja-pricing__card:nth-child(3) .ja-pricing__card-cta", "Try 30 days free in the app"],
    ["attr", ".ja-pricing__card:nth-child(3) .ja-pricing__card-cta", "aria-label", "Try the Ultra plan free for 30 days in the SideClip app"],
    ["text", ".ja-pricing__card:nth-child(3) .ja-pricing__card-link", "Explore Ultra features →"],
    ["text", ".ja-pricing__action-kicker", "Not sure? Start with Free."],
    ["text", ".ja-pricing__action-copy > p:last-child", "No account required. Install SideClip on your Mac and try it right away."],
    ["text", ".ja-pricing__action-download", "Download free for Mac"],
    ["attr", ".ja-pricing__action-download", "aria-label", "Download SideClip free for Mac"],
    ["html", ".ja-pricing__billing-note", "<span>*Daily prices are annual prices divided by 365. Annual plans are billed yearly.</span><span>See the FAQ for pricing details.</span>"],
    ["text", ".ja-pricing__link", "Compare plan features"],
    ...
    ["html", "#cta-title", "Put your clipboard history<br />beside your Mac."],
    ...
    ["text", ".trust-list li:nth-child(2)", "Choose monthly or annual billing"],
    ["attr", ".feature-lightbox__dialog", "aria-label", "Zoomed image"],
    ["attr", ".feature-lightbox__close", "aria-label", "Close zoomed image"],
    ["attr", ".mobile-download-dialog__close", "aria-label", "Close download instructions"],
    ["text", ".mobile-download-dialog__eyebrow", "Download for Mac"],
    ["text", "#mobile-download-dialog-title", "Continue on your Mac"],
    ["text", "#mobile-download-dialog-description", "SideClip is a Mac app. Open the link below on your Mac to download it for free."],
    ["text", "[data-mobile-download-share]", "Share to your Mac"],
    ["text", "[data-mobile-download-copy]", "Copy link"],
